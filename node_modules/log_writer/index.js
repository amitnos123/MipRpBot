module.exports = class log_writer {
	...
	/// PARAM
	//debugLvl(string) - What kind of log will it be
	//message(string) - The message which will be logged
	/// Description - Write down the message in to the console and also into the file for the current date in a specific template
	...
	/// PARAM
	/// Description - Write down in to the console and also into the file a specific string for splitting in the log
	logSplit() {
		const fs = require('fs');
		// const path = require('path');
		const constants = require('consts');
